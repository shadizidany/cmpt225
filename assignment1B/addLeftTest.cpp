// Assignment 1B
// addLeftTest.cpp: Tests AList addLeft operation by attempting to exceed capacity (testing assert)

#include "AList.h"

int main() {
    // Program title
    cout << endl << "--- AList addLeft Testing Program ---" << endl;

    // Create an instance of AList
    cout << endl << "Step 1: Creating a new AList<int>" << endl;
    AList<int> list;

    // Add 12 elements using addLeft
    cout << endl << "Step 2: Adding numbers 1 through 12 using addLeft()" << endl;
    ...
    cout << endl << "Step 4: Attempting to add one more element beyond capacity" << endl
         ...
         << "Adding 13 using 'list.addLeft(13);' ..." << endl << endl;
