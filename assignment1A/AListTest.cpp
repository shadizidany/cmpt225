...
int main() {
    cout << "--- Testing AList Implementation ---" << endl;

    // Create an AList of integers
    AList<int> list;

    cout << endl << "Step 1: Initial state of the list." << endl;
    cout << "Displaying list contents:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
    ...
    list.addRight(17);
    list.addRight(88);
    cout << "Displaying list contents after adding to the right:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
    ...
    list.addLeft(23);
    list.addLeft(9);
    cout << "Displaying list contents after adding to the left:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
    ...
    cout << "Displaying list contents after removing from the right:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
    ...
    cout << "Displaying list contents after removing from the left:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
    ...
    list.clear();
    cout << "Displaying list contents after clearing:" << endl;
    list.display();
    cout << "Displaying debugging information:" << endl;
    list.ddisplay();
